...
export const registerCall = async (userCredential, dispatch) => {
    ...
    try {
        const res = await axios.post("http://localhost:5001/api/v1/auth/register", userCredential, { withCredentials: true });
...
export const loginCall = async (userCredential, dispatch) => {
    ...
    try {
        const res = await axios.post("http://localhost:5001/api/v1/auth/login", userCredential, { withCredentials: true });
